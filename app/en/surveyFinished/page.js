        ...
        if (!loading) {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    handleAlertBarOpen()
                    setVCodeError("Successfully uploaded the questionnaire")
                    ...
                    setAlertState("error")
                    handleAlertBarOpen()
                    setVCodeError("The questionnaire has already been submitted, please do not submit it again")
                    setSuccess(false);
                    setLoading(false);
                }
            } catch (error) {
                setAlertState("error")
                handleAlertBarOpen()
                setVCodeError("Server is busy, please try again later.")
                setSuccess(false);
                setLoading(false);
            }
        }
                ...
                isClient ?
                    <div>
                        ...
                        <div className={styles.question}>
                            ...
                            <p>
                                Please click the button below to complete this questionnaire
                            </p>
                        </div>
