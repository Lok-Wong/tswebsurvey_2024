...
function App() {
    ...
    const handleNextButton = () => {
        ...
        router.push("/en/surveyStudentFinised")
    }
                ...
                isClient ?
                    <div>
                        ...
                        <div className={styles.question}>
                            <FormControl>
                                <FormLabel id="badWeatherPickup-label"><h3>1) Are there any changes in the mode of transportation? (Multiple choices)</h3></FormLabel>
                                <RadioGroup
                                ...
                                >
                                    ...
                                    <FormControlLabel sx={{ color: "black" }} value="提早出門上學" control={
                                        ...
                                        label="Leaving home earlier to school"
                                    />
                                    {
                                    ...
                                    <FormControlLabel sx={{ color: "black" }} value="改變交通方式" control={
                                        ...
                                        label="Changing the mode of transportation"
                                    />
                                    {
                                        survey.tripChange.transitionChange.state == true ?
                                            <Box
                                                ...
                                                autoComplete="off" >
                                                <p>
                                                    The changed mode of transportation is?
                                                </p>
                                                <TextField
                                    ...
                                    <FormControlLabel sx={{ color: "black" }} value="不出門上學和等待教青局的消息" control={
                                        <Checkbox
                                            ...
                                            onChange={handleCheckBoxChange}
                                            name='waitForNews' />} label="Stay home and wait for announcement from DSEDJ" />
