    ...
    <main className={styles.main}>
      ...
      <div className={styles.startLetter}>
        <a className={styles.letterText}>
          ...
          <br />
          <br />
          If you have any inquiries regarding this survey, please feel free to contact us during office hours at the following phone numbers:<br /><br />
          63703082 <br />
          63703083 <br />
          63946045 <br />
      ...
      >
        <Box className={styles.signContentBox}>
          ...
          1. Purpose of data collection and processing<br />
