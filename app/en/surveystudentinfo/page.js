                ...
                isClient ?
                    <div className={styles.pageWidth}>
                        ...
                        <div key={1} className={styles.question}>
                            <FormControl>
                                <FormLabel id="school-area-label"><h3>1) The school is located at:</h3></FormLabel>
                                <RadioGroup
                                    id="school-area"
                        ...
                        {schoolNameSelectType == "input" ?
                            <div key={323} className={styles.question}>
                                <FormControl>
                                    <FormLabel id="school-type-label"><h3>2.1) Type of Education:</h3></FormLabel>
                                    <RadioGroup
                                        id="school-type"
                        ...
                        <div key={4} className={styles.question} >
                            <FormControl>
                                <FormLabel id="class-level-label"><h3>3) Educational Level:</h3></FormLabel>
                                <RadioGroup
                                    id="class-level"
                        ...
                        <div key={5} className={styles.question} >
                            <FormControl>
                                <FormLabel id="level-type-label"><h3>4) Grade Level:</h3></FormLabel>
                                <RadioGroup
                                    id="level-Type"
                        ...
                        <div key={6} className={styles.question}>
                            <FormControl>
                                <FormLabel id="gender-label"><h3>5) Gender:</h3></FormLabel>
                                <RadioGroup
                                    ...
                                    value={survey.gender}
                                >
                                    <FormControlLabel sx={{ color: "black" }} value="男" control={<Radio />} label="Male" />
                                    <FormControlLabel sx={{ color: "black" }} value="女" control={<Radio />} label="Female" />
                                </RadioGroup>
                        ...
                        <div key={7} className={styles.question}>
                            <FormControl>
                                <FormLabel id="age-label"><h3>6) Age:</h3></FormLabel>
                                <RadioGroup
                                    ...
                                    value={survey.age}
                                >
                                    <FormControlLabel sx={{ color: "black" }} value="0~4歲" control={<Radio />} label="0~4 Years Old" />
                                    <FormControlLabel sx={{ color: "black" }} value="5~9歲" control={<Radio />} label="5~9 Years Old" />
                                    <FormControlLabel sx={{ color: "black" }} value="10~14歲" control={<Radio />} label="10~14 Years Old" />
                                    <FormControlLabel sx={{ color: "black" }} value="15~19歲" control={<Radio />} label="15~19 Years Old" />
                                    <FormControlLabel sx={{ color: "black" }} value="≥20歲 " control={<Radio />} label="≥20 Years Old" />
                                </RadioGroup>
                        ...
                        <div key={8} className={styles.question}>
                            <FormControl>
                                <FormLabel id="cross-border-student-label"><h3>7) Please select whether cross-border travel before school or after school is required</h3></FormLabel>
                                <RadioGroup
                                    id="crossBorderCheck"
